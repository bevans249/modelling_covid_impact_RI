...
ggsave(filename = here::here(fig_folder, "forecast.png"),
       plot = vis, 
...
write.csv(
  tt_reg,
  here::here(csv_folder, "ttest_region_dtp1.csv"),
  row.names = FALSE)
write.csv(
  tt_inc_grp,
  here::here(csv_folder, "ttest_income_dtp1.csv"),
  row.names = FALSE)
write.csv(
  tt_gavi_grp,
  here::here(csv_folder, "ttest_gavi_dtp1.csv"),
  row.names = FALSE)
write.csv(
  tt_gavi_grp_bin,
  here::here(csv_folder, "ttest_gavi_binary_dtp1.csv"),
  row.names = FALSE)
write.csv(
  tt_total,
  here::here(csv_folder, "ttest_total_dtp1.csv"),
  row.names = FALSE)
write.csv(
  tt_total_clean,
  here::here(csv_folder, "ttest_total_dtp1_clean.csv"),
  row.names = FALSE)
```
...
write.csv(
  dtp1_output,
  here::here(csv_folder, "dtp1_summary_output.csv"),
  row.names = FALSE)
```
...
write.csv(
  order,
  here::here(csv_folder, "DTP1_ARIMA_models.csv"),
  row.names = FALSE)
