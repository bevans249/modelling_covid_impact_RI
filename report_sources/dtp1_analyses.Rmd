...
if (params$data == "dtp1") {
  ...
  file_path_old <- here::here("data", "dtp1.csv")
} else if (params$data == "dtp3") {
  file_path <- here::here("data", "dtp3_oct.csv")
  file_path_old <- here::here("data", "dtp3.csv")
} else {
...
if (params$data == "dtp3") {
  removed_countries <- c("Haiti", "Jordan", "Venezuela (Bolivarian Republic of)")
}
